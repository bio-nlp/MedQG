...
from src.prompt_lib.prompt_lib.backends.wrapper import BaseAPIWrapper
from src.prompt_lib.prompt_lib.backends.self_hosted import OpenSourceAPIWrapper
#from src.prompt_lib.prompt_lib.backends.anthropic_api import AnthropicAPIWrapper
...
if os.getenv("OPENAIORG") is not None:
    openai.organization = ""
...
class OpenaiAPIWrapper:
    chat_engines = ["gpt-3.5-turbo", "gpt-4","gpt-4-1106-preview","gpt-4-0125-preview", "gpt-3.5-turbo-0301", "gpt-4-0314"]
